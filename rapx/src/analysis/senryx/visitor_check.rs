...
use super::{contracts::{abstract_state::AlignState, state_lattice::Lattice}, visitor::BodyVisitor};
...
impl<'tcx> BodyVisitor<'tcx> {
    ...
    pub fn check_align(&self, arg:usize) -> bool {
        ...
        if obj_ty.is_none() || var_ty.is_none() {
            rap_warn!("In func {:?}, visitor checker error! Can't get {arg} in chain!",get_cleaned_def_path_name(self.tcx, self.def_id));
        }
